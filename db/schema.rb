...
ActiveRecord::Schema.define(version: 20150622203838) do
  ...
  add_index "joinings", ["idea_id"], name: "index_joinings_on_idea_id", using: :btree
  ...
  add_foreign_key "joinings", "ideas"
